...
export default function AppStore({ os }) {
  if (os === 'ios') {
    return (
      <View
        as="svg"
  ...
  if (os === 'android') {
    return (
      ...
      >
        ...
        <path fill="#fff" stroke="#fff" strokeWidth="0.2" strokeMiterlimit="10" d="M47.4 10.2c0 .8-.2 1.5-.7 2-.6.6-1.3.9-2.2.9s-1.6-.3-2.2-.9c-.6-.6-.9-1.3-.9-2.2s.3-1.6.9-2.2c.6-.6 1.3-.9 2.2-.9.4 0 .8.1 1.2.3.4.2.7.4.9.7l-.5.5c-.4-.5-.9-.7-1.6-.7-.6 0-1.2.2-1.6.7-.5.4-.7 1-.7 1.7s.2 1.3.7 1.7 1 .7 1.6.7c.7 0 1.2-.2 1.7-.7.3-.3.5-.7.5-1.2h-2.2v-.8h2.9v.4zM52 7.7h-2.7v1.9h2.5v.7h-2.5v1.9H52v.8h-3.5V7H52v.7zM55.3 13h-.8V7.7h-1.7V7H57v.7h-1.7V13zM59.9 13V7h.8v6h-.8zM64.1 13h-.8V7.7h-1.7V7h4.1v.7H64V13h.1zM73.6 12.2c-.6.6-1.3.9-2.2.9-.9 0-1.6-.3-2.2-.9-.6-.6-.9-1.3-.9-2.2s.3-1.6.9-2.2 1.3-.9 2.2-.9c.9 0 1.6.3 2.2.9s.9 1.3.9 2.2-.3 1.6-.9 2.2zm-3.8-.5c.4.4 1 .7 1.6.7s1.2-.2 1.6-.7c.4-.4.7-1 .7-1.7s-.2-1.3-.7-1.7c-.4-.4-1-.7-1.6-.7s-1.2.2-1.6.7c-.4.4-.7 1-.7 1.7s.2 1.3.7 1.7zM75.6 13V7h.9l2.9 4.7V7h.8v6h-.8l-3.1-4.9V13h-.7z" />
        ...
        <g>
          <linearGradient id="SVGID_1_" x1="21.7949" x2="5.0125" y1="1026.705" y2="1043.4873" gradientTransform="translate(0 -1017.9998)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#00a0ff" />
            <stop offset=".00657445" stopColor="#00a1ff" />
          ...
          <linearGradient id="SVGID_2_" x1="33.8343" x2="9.6374" y1="1038.0498" y2="1038.0498" gradientTransform="translate(0 -1017.9998)" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="SVGID_3_" x1="24.8153" x2="2.057" y1="1040.2844" y2="1063.0427" gradientTransform="translate(0 -1017.9998)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#ff3a44" />
            <stop offset="1" stopColor="#c31162" />
          </linearGradient>
          <path fill="url(#SVGID_3_)" d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4" />
          <linearGradient id="SVGID_4_" x1="7.2617" x2="17.4243" y1="1018.2116" y2="1028.3741" gradientTransform="translate(0 -1017.9998)" gradientUnits="userSpaceOnUse">
          ...
          <path opacity="0.12" enableBackground="new" d="M10.4 32.3c-.3-.3-.4-.8-.4-1.4v.1c0 .6.2 1.1.5 1.4v-.1h-.1zM32 21.3l-5 2.8.1.1 4.9-2.8c.7-.4 1-.9 1-1.4 0 .5-.4.9-1 1.3z" />
          <path fill="#fff" d="M12.5 7.6L32 18.7c.6.4 1 .8 1 1.3 0-.5-.3-1-1-1.4l-19.5-11c-1.4-.9-2.5-.3-2.5 1.3V9c0-1.5 1.1-2.2 2.5-1.4z" opacity=".25" />
        </g>
      </View>
    );
  }
